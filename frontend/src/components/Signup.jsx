...
const Signup = () => {
  ...
  const signupHandler = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('https://friendschat-7iht.onrender.com/api/v1/user/register', input, {
        headers:{
    ...
    <div className="flex items-center w-screen h-screen justify-center">
      ...
      className="shadow-lg flex flex-col gap-5 p-8 border rounded-md w-full max-w-md bg-white">
        ...
        <span className='text-center'>
          ...
          <Link to="/login" className='text-blue-600 hover:text-blue-300'>Login</Link>
        </span>
